...
@Component({
  selector: 'app-property-rent-slip',
  templateUrl: './property-rent-slip.component.html',
  styleUrls: ['./property-rent-slip.component.css']
})
export class PropertyRentSlipComponent implements OnInit {
...
property_rent_slip(property_id:any){
  ...
  this.InvoiceDetailsService.property_rent_slip(param).subscribe(
    response => {
